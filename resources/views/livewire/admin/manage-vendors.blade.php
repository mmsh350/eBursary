    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">
                Manage external vendors and payment details.
            </p>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-300">
                <thead class="bg-gray-50">
                    <tr>
                        <th scope="col"
                            class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">Vendor Name
                        </th>
                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">TIN</th>
                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Bank
                            Details</th>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                @if ($vendor->bank_name)
                                    ...
                                    <div class="text-xs text-gray-400">{{ $vendor->account_number }}</div>
                                @else
                                    -
                                @endif
                            </td>
                        ...
                        <div>
                            <div class="mt-3 text-center sm:mt-5">
                                ...
                                <div class="mt-2 text-left space-y-4">
                                    ...
                                    <div>
                                        <label for="name"
                                            class="block text-sm font-medium leading-6 text-gray-900">Vendor
                                            Name</label>
                                        <div class="mt-1">
                                    ...
                                    <div>
                                        <label for="tin"
                                            class="block text-sm font-medium leading-6 text-gray-900">Tax Identification
                                            Number (TIN)</label>
                                        <div class="mt-1">
                                            <x-text-input type="text" wire:model="tin" id="tin" />
                                            @error('tin')
                                                <span class="text-red-500 text-xs">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div>
                                        <label for="account_number"
                                            class="block text-sm font-medium leading-6 text-gray-900">Account
                                            Number</label>
                                        <div class="mt-1">
                                            <x-text-input type="text" wire:model="account_number"
                                                id="account_number" />
