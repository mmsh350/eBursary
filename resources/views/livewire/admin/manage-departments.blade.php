    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">
                Manage organization departments and their codes.
            </p>
        </div>
                            ...
                            <td
                                ...
                                <div class="flex justify-end gap-2">
                                    ...
                                    <button wire:click="delete({{ $dept->id }})"
                                        onclick="confirm('Are you sure? This might affect linked units and users.') || event.stopImmediatePropagation()"
                        ...
                        <div>
                            <div class="mt-3 text-center sm:mt-5">
                                ...
                                <div class="mt-2 text-left space-y-4">
                                    ...
                                    <div>
                                        <label for="name"
                                            class="block text-sm font-medium leading-6 text-gray-900">Department
                                            Name</label>
                                        <div class="mt-1">
